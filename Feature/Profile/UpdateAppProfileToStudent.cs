...
{
    public class UpdateAppProfileToStudent
    {
        public UpdateAppProfileToStudent() { }

        public class UpdateAppProfileToStudentCommand : IRequest<string>, ICommandEvent
        {
            public string ProfileId { get; set; }
            public UpdateAppProfileToStudentCommand(string profileId) => ProfileId = profileId;
        }

        public class UpdateAppProfileToStudentCommandHandler : IRequestHandler<UpdateAppProfileToStudentCommand, string>
        {
