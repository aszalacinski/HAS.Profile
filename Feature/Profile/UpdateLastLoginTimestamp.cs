...
namespace HAS.Profile.Feature.Profile
{
    public class UpdateLastLoginTimestamp
    {
        public class UpdateLastLoginTimestampCommand : IRequest<string>
        {
            ...
            public UpdateLastLoginTimestampCommand(string profileId) => ProfileId = profileId;
        }

        public class UpdateLastLoginTimestampCommandHandler : IRequestHandler<UpdateLastLoginTimestampCommand, string>
        {
            private readonly ProfileContext _db;
            private readonly IMediator _mediator;
            private readonly MapperConfiguration _mapperConfiguration;

            public UpdateLastLoginTimestampCommandHandler(ProfileContext db, IMediator mediator)
            {
                _db = db;
                _mediator = mediator;
            ...
            public async Task<string> Handle(UpdateLastLoginTimestampCommand cmd, CancellationToken cancellationToken)
            {
