...
namespace HAS.Profile.Feature.Profile
{
    ...
    {
        public class UpdateLocationDetailsCommand : IRequest<string>, ICommandEvent
        {
        ...
        public class UpdateLocationDetailsCommandHandler : IRequestHandler<UpdateLocationDetailsCommand, string>
        {
            private readonly ProfileContext _db;
            private readonly IMediator _mediator;
            private readonly MapperConfiguration _mapperConfiguration;

            public UpdateLocationDetailsCommandHandler(ProfileContext db, IMediator mediator)
            {
                _db = db;
                _mediator = mediator;
            ...
            public async Task<string> Handle(UpdateLocationDetailsCommand cmd, CancellationToken cancellationToken)
            {
