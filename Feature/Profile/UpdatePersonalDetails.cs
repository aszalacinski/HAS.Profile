...
namespace HAS.Profile.Feature.Profile
{
    ...
    {
        public class UpdatePersonalDetailsCommand : IRequest<string>, ICommandEvent
        {
        ...
        public class UpdatePersonalDetailsCommandHandler : IRequestHandler<UpdatePersonalDetailsCommand, string>
        {
            private readonly ProfileContext _db;
            private readonly IMediator _mediator;
            private readonly MapperConfiguration _mapperConfiguration;

            public UpdatePersonalDetailsCommandHandler(ProfileContext db, IMediator mediator)
            {
                _db = db;
                _mediator = mediator;
            ...
            public async Task<string> Handle(UpdatePersonalDetailsCommand cmd, CancellationToken cancellationToken)
            {
