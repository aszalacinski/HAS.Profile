...
namespace HAS.Profile.Feature.Tribe
{
    public class DeleteStudentFromTribe
    {
        public class DeleteStudentFromTribeCommand : IRequest<string>
        {
            ...
            public DeleteStudentFromTribeCommand(string instructorId, string tribeId, string studentId)
            {
        ...
        public class DeleteStudentFromTribeCommandHandler : IRequestHandler<DeleteStudentFromTribeCommand, string>
        {
            ...
            public async Task<string> Handle(DeleteStudentFromTribeCommand cmd, CancellationToken cancellationToken)
            {
